...
$sql = "SELECT DISTINCT kota FROM theater";
    ...
    <!--[if lt IE 9]>
      ...
      <script>
        function tampil(kota){
          ...
          xmlhttp.open("GET", "pilihkota.php?kota=" + kota, true);
          xmlhttp.send();
        }
      </script>
    </head>
          ...
          <div class="modal-dialog">
           <div class="loginmodal-container">
            <form action="user.php" method="post">
              <input type="hidden" name="hal" id="hal" value="theaters.php">
...
<div class="container-fluid" style="background:url(dummy/backSI.jpg) 50% 0 fixed; background-size:cover; margin-top: -2%;color:white;">
  <h3>Theaters</h3>
  <div class="row">
    <div class="col-md-1">
      Pilih Kota:
    ...
    <div class="col-md-4">
      <select id="kota" class="form-control col-md-5" onchange="tampil(this.value)">
