	  ...
	  <script>
		$(document).ready(function(){
			...
			$('.poster').hover(function(){
				...
				$('#ganti').css("background-image", "url(dummy/blur_"+$(this).attr("id")+")"); 
        $('.status').css("color","yellow");
			...
			$('.poster2').hover(function(){
				$('#ganti2').css("background-image", "url(dummy/blur_"+$(this).attr("id")+")"); 
...
<div class="container-fluid" style="margin-top:-2%;">
 <div class="row blur" id="ganti">
  ...
  <center><h1 style ="margin-top:4%" class="status">Now Playing</h1></center><br>
			...
			while($row=mysql_fetch_row($result))
			{
				if($count<8){
					...
					<div class="overlay poster" id="'.$row[13].'" >
					  <center><div class="text">'.$row[1].'<br>'.$row[2].' Menit <br><br>
...
<div class="row" id="ganti2">
 <center> <h1 style ="margin-top:4%" class="status2">Coming Soon</h1></center><br>
	<?php
